...
public class classInstrucaoIf {
	...
	public static void main(String[] args) {
		...
		System.out.printf("O aluno obteve nota total %.2f. A media por avaliaçao de %.2f. A frequencia foi %.2f. Com isso o aluno está %s.", total, mediaAvaliacoes, frequencia * 100, situacao);
